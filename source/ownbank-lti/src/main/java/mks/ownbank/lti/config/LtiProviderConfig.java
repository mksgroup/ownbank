...
public class LtiProviderConfig {
    ...
    @JsonProperty
    public String default_base_url = "http://localhost:9090/ownbank-lti";
    @JsonProperty
    public String secure_base_url = "http://localhost:9090/ownbank-lti";
    @JsonProperty
    public String basic_lti_launch_path = "/vote";
