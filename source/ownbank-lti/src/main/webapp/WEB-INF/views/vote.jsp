...
<div>
    <!-- Action bar -->
    <jsp:include page="vote-nav.jsp"></jsp:include>
    <div class="jumbotron">
    <H3>
    Hãy bấm vào <b>Hình lục giác</b> để chọn điểm may mắn ngẫu nhiên của bạn.
    <br/>
...
<script>
    ...
    bgImage.src = "resources/image/ctc_hcm.jpg";
    ...
    function submitSelectedNum(luckyNum) {
        ...
        $.ajax({
            ...
            success : function(result) {
              ...
              $('#status').html("<H3>Con số may mắn của bạn là:<b>" + luckyNum + "</b></H3>");
            },
